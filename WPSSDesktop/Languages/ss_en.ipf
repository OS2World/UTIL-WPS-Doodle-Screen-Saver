...
When Doodle's Screen Saver is installed correctly, its settings must be set at
the Desktop properties notebook, where they are integrated. You will find a new
tab labelled :hp2.Screen Saver:ehp2. in that notebook, and the tab in turn is
made up of three pages.

:p.Select the title for either of them below for more information on the settings
you will find within:

:ul compact.
:li.:link reftype=hd res=1000.General parameters:elink.
...
.*
:h3 res=2002.Information about DPMS
...
These are settings shared among all of the Screen Saver properties pages.
