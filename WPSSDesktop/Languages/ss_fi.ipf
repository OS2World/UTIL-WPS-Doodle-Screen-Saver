...
:ul compact.
:li.:link reftype=hd res=1001.Yleisasetukset:elink.
:li.:link reftype=hd res=1002.Salasanasuojaus:elink.
:li.:link reftype=hd res=6001.Peru:elink.
:li.:link reftype=hd res=6002.Oletus:elink.
:eul.
.*
.* Help for General settings groupbox
.*
:h1 res=1001.Yleisasetukset
...
:p.Toinen sivu :hp2.N„yt”ns„„st„j„n:ehp2. asetuksissa on
:hp2.DPMS-asetukset:ehp2. page. T„„ll„ n„yt”ns„„st„j„lle voidaan valita k„ytt””n erilaiset 
:link reftype=hd res=2002.
DPMS:elink.-palvelut, jos ne ovat k„ytett„viss„.
:p.
N„yt”ns„„st„j„n kielen vaihtaminen tehd„„n vet„m„ll„ ja pudotamalla Lokaaliobjekti t„lle sivulle. Lis„tietoa siit„ l”ytyy
:link reftype=hd res=5000.
t„„lt„:elink..
:p.
Yksityiskohtaisen selityksen kustakin kent„st„ saat valitsemalla alla olevasta listasta:
:ul compact.
:li.:link reftype=hd res=2001.DPMS-asetukset:elink.
:li.:link reftype=hd res=6001.Peru:elink.
:li.:link reftype=hd res=6002.Oletus:elink.
:eul.
.*
...
.*
:h1 res=2002.Tietoa DPMS&colon.st„
...
.* General help for the page
.*
:h1 res=3000.N„yt”ns„„st„j„
:p.Kolmas sivu :hp2.N„yt”ns„„st„j„n:ehp2. asetuksissa on
:hp2.N„yt”ns„„st„j„n moduulit:ehp2. -sivu. T„ll„ sivulla on luettelo k„ytett„vist„ n„yt”ns„„st„j„n
:link reftype=hd res=3002.
moduuleista:elink., moduuleita voidaan muokata, ja voidaan valita k„ytt””n k„ytett„v„ n„yt”ns„„st„j„n moduuli.
:p.
N„yt”ns„„st„j„n kielen vaihtaminen on mahdollista vet„m„ll„ ja pudottamalla Lokaaliobjekti t„lle sivulle. Lis„tietoa kielen vaihtamisesta saat
:link reftype=hd res=5000.
t„„lt„:elink..
...
Yksityiskohtaisen selityksen kustakin kent„st„ saat valitsemalla alla olevasta listasta:
:ul compact.
:li.:link reftype=hd res=3001.N„yt”ns„„st„j„n moduulit:elink.
:li.:link reftype=hd res=6001.Peru:elink.
:li.:link reftype=hd res=6002.Oletus:elink.
:eul.
.*
...
.*
:h1 res=3001.N„yt”ns„„st„j„n moduulit
...
.*
:h1 res=5000.N„yt”nohjaimen kielen valinta
